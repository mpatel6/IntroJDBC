...
public class SimpleDB_MySql_Demo {
	...
	public static void main(String[] args) {
		...
		//db.password = "advjava";
                ...
                //rigid as hardcoded database, SQL.
                //Program to Database Access Strategy: Rigid
                //Service to Database Access Strategy: Connect different databases
                //DAO service class talks to access data. Uses domain terminology. 
                //DAO decouples service and DAS
                //Service shields program. Encapsulation

		try {
			  Class.forName (db.driverClassName);
                          //loads driver class in memory. not creating an instance as it is static method. DOne in try catch because it throws checked exception
			  db.conn = DriverManager.getConnection(db.url, db.userName, db.password);
                          //once loaded then we use 
		}
